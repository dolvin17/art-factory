export const NFTProgramId = 'dolvin17NFT.aleo';

export const NFTProgram = `program dolvin17NFT.aleo;
...
function initialize_collection:
    ...
    assert.eq self.caller aleo1vc4w4r94s82y8mls6ujj6s89txegdmlk4pteh8y5nem57x79n5xs9st7nw;
    async initialize_collection r0 r1 r2 into r3;
    output r3 as dolvin17NFT.aleo/initialize_collection.future;
...
function add_nft:
    ...
    output r4 as dolvin17NFT.aleo/add_nft.future;
...
function add_minter:
    ...
    output r3 as dolvin17NFT.aleo/add_minter.future;
...
function update_toggle_settings:
    ...
    output r1 as dolvin17NFT.aleo/update_toggle_settings.future;
...
function set_mint_block:
    ...
    output r1 as dolvin17NFT.aleo/set_mint_block.future;
...
function update_symbol:
    ...
    output r1 as dolvin17NFT.aleo/update_symbol.future;
...
function update_base_uri:
    ...
    output r1 as dolvin17NFT.aleo/update_base_uri.future;
...
function open_mint:
    ...
    output r4 as dolvin17NFT.aleo/open_mint.future;
...
function mint:
    ...
    output r7 as dolvin17NFT.aleo/mint.future;
...
function claim_nft:
    ...
    output r6 as dolvin17NFT.aleo/claim_nft.future;
...
function authorize:
    ...
    output r2 as dolvin17NFT.aleo/authorize.future;
...
function transfer_public:
    ...
    output r5 as dolvin17NFT.aleo/transfer_public.future;
...
function convert_private_to_public:
    ...
    output r3 as dolvin17NFT.aleo/convert_private_to_public.future;
...
function convert_public_to_private:
    ...
    output r5 as NFT.record;
    output r6 as dolvin17NFT.aleo/convert_public_to_private.future;
